...
TEST_F(DecimationTest, BoundaryCheck){
    ...
    EXPECT_EQ(mesh.nearBoundary(mesh.get_simplex_up({0,1})), false);
    EXPECT_EQ(mesh.onBoundary(mesh.get_simplex_up({0,3})), false);
    EXPECT_EQ(mesh.nearBoundary(mesh.get_simplex_up({0,3})), false);
    ...
    EXPECT_EQ(mesh.nearBoundary(mesh.get_simplex_up({3,5})), false);
    ...
    EXPECT_EQ(mesh.nearBoundary(mesh.get_simplex_up({4,5})), false);
    EXPECT_EQ(mesh.onBoundary(mesh.get_simplex_up({1,2})), false);
    EXPECT_EQ(mesh.nearBoundary(mesh.get_simplex_up({1,2})), false);
    EXPECT_EQ(mesh.onBoundary(mesh.get_simplex_up({2,4})), false);
    EXPECT_EQ(mesh.nearBoundary(mesh.get_simplex_up({2,4})), false);
    ...
    EXPECT_EQ(mesh.nearBoundary(mesh.get_simplex_up({1,6})), false);
